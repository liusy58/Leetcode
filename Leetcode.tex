...
\fbox{%
  ...
  \textbf{Given a string s, find the longest palindromic substring in s. You may assume that the maximum length of s is 1000.}
  }
  }
  \section*{例子}
  \fbox{%
...
\section*{\href{https://leetcode.com/problems/reverse-integer/}{题目} }
\fbox{%
  \parbox{\textwidth}{%

  \textbf{Given a 32-bit signed integer, reverse digits of an integer.}
